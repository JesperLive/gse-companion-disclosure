...
>
> **Correction, 2026-07-18.** The bolded sentence above ends by saying my "point-1 reading is substantially weakened." That was an error in the opposite direction — the README's retraction block records the same correction, dated 2026-07-17, and it belongs in this file too, since this is where the README sends readers for the full detail. Point 2 asks whether the code is completely visible. Point 1 asks whether the add-on is distributed free of charge and whether there are premium versions with additional for-pay features. Those are different tests. `GSE_QoL` being public source answers the first one. It does not answer the second, and I am not withdrawing point 1 on point 2's evidence. The point-2 withdrawal stands as written.
>
