...
- **Ten files differ from 3.3.24-2.** Five are `.toc` version strings. The substantive ones are `GSE_Options/Support.lua` (+406 B), `GSE/Localization/ModL_enUS.lua` (+103 B), `GSE_Utils/Patrons.lua` (+741 B, a patron-name list), and `CHANGELOG.md`.
