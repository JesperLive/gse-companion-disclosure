-- Verbatim extract from the in-game GSE addon: Codec.lua lines 1-84
-- ChaCha20 stream cipher (sigma constants + quarter-round + 20 rounds) and DecodePackedMessage: the !GSE3!+ sequence format is encrypted with a 32-byte key embedded in the addon, keyed by an id byte so keys can be rotated.
